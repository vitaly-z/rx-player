 ...
 */
import { IContentProtections, IContentProtectionInitData, IContentProtectionKID, IParsedRepresentation } from "../parsers/manifest";
import { IRepresentationIndex } from "./representation_index";
import { IAdaptationType } from "./types";
export { IContentProtectionInitData, IContentProtectionKID, IContentProtections, };
/**
...
declare class Representation {
     ...
     */
    getEncryptionData(drmSystemId: string): IContentProtectionInitData[];
    /**
     ...
     * @returns {Array.<Object>}
     */
    getAllEncryptionData(): IContentProtectionInitData[];
    /**
