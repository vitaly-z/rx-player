...
import { IPipelineLoaderResponse, IPipelineLoaderResponseValue } from "./create_manifest_loader";
...
export interface ICoreManifestPipeline {
    ...
    parse(response: IPipelineLoaderResponseValue<ILoadedManifest>, url?: string, externalClockOffset?: number): Observable<IFetchManifestResult>;
}
 ...
 * @returns {Function}
 */
export default function createManifestPipeline(pipelines: ITransportPipelines, pipelineOptions: IManifestPipelineOptions, warning$: Subject<ICustomError>): ICoreManifestPipeline;
