 ...
 */
import { ILoaderDataLoadedValue, ISegmentLoaderArguments } from "../../../transports";
 ...
 * @returns {Object}
 */
export default function getSegmentPipelineOptions(bufferType: string, { segmentRetry, offlineRetry, lowLatencyMode }: {
    segmentRetry?: number;
    offlineRetry?: number;
