...
var QueuedSourceBuffer = /** @class */ (function () {
    ...
    QueuedSourceBuffer.prototype.removeBuffer = function (start, end) {
        ...
        return this._addToQueue({ type: SourceBufferOperation.Remove, value: { start: start, end: end } });
    };
    /**
     ...
     * @returns {Array.<Object>}
     */
    QueuedSourceBuffer.prototype.getPendingOperations = function () {
     ...
     * @returns {Observable}
     */
    QueuedSourceBuffer.prototype._addToQueue = function (operation) {
        var _this = this;
    ...
    QueuedSourceBuffer.prototype._pushSegmentData = function (data) {
        ...
        if (this._sourceBuffer.timestampOffset !== timestampOffset) {
            ...
            var contentOffset = window.videoContentOffset !== undefined &&
                this.bufferType === "video" ?
                window.videoContentOffset :
                0;
    ...
    switch (item.type) {
        case SourceBufferOperation.Push:
            ...
            var inventoryData = { period: inventoryInfos.period,
                ...
                segment: inventoryInfos.segment, start: start,
                end: end };
            return objectAssign({ steps: steps, inventoryData: inventoryData }, item);
        case SourceBufferOperation.Remove:
        case SourceBufferOperation.EndOfSegment:
            return item;
        default:
