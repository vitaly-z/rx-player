 ...
 */
export default function getNeededSegments({ content, currentPlaybackTime, knownStableBitrate, loadedSegmentPendingPush, neededRange, segmentInventory, }: ISegmentFilterArgument): ISegment[];
