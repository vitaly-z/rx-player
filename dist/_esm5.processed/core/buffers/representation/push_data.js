 ...
 * @returns {Observable}
 */
export default function pushDataToSourceBufferWithRetries(clock$, queuedSourceBuffer, dataInfos) {
    ...
    return append$.pipe(catchError(function (appendError) {
        ...
        return observableConcat(forceGarbageCollection(clock$, queuedSourceBuffer).pipe(ignoreElements()), append$).pipe(catchError(function (forcedGCError) {
