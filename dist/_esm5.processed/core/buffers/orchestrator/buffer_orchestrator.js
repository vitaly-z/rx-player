 ...
 * periods.
 */
export default function BufferOrchestrator(content, clock$, abrManager, sourceBuffersStore, segmentFetcherCreator, options) {
    ...
    function manageEveryBuffers(bufferType, basePeriod) {
        ...
        function launchConsecutiveBuffersForPeriod(period) {
            return manageConsecutivePeriodBuffers(bufferType, period, destroyBuffers$).pipe(filterMap(function (message) {
                switch (message.type) {
