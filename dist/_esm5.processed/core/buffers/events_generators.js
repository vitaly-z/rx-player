...
var EVENTS = {
    activeBuffer: function (bufferType) {
        return { type: "active-buffer", value: { bufferType: bufferType } };
    },
    ...
    fullBuffer: function (bufferType) {
        return { type: "full-buffer", value: { bufferType: bufferType } };
    },
    ...
    periodBufferReady: function (type, period, adaptation$) {
        return { type: "periodBufferReady", value: { type: type, period: period, adaptation$: adaptation$ } };
    },
    periodBufferCleared: function (type, period) {
        return { type: "periodBufferCleared", value: { type: type, period: period } };
    },
