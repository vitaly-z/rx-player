...
var FORCED_ENDED_THRESHOLD = config.FORCED_ENDED_THRESHOLD;
/** Player state dictionnary. */
export var PLAYER_STATES = { STOPPED: "STOPPED",
    LOADED: "LOADED",
    LOADING: "LOADING",
    PLAYING: "PLAYING",
    PAUSED: "PAUSED",
 ...
 * @returns {string}
 */
export default function getLoadedContentState(mediaElement, isPlaying, stalledStatus) {
    var _a;
    ...
    if (stalledStatus !== null) {
        ...
        var gapBetweenDurationAndCurrentTime = Math.abs(mediaElement.duration -
            (mediaElement.currentTime + ((_a = window.offset) !== null && _a !== void 0 ? _a : 0)));
