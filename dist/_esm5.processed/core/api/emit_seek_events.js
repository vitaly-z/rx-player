 ...
 */
import { defer as observableDefer, EMPTY, fromEvent as observableFromEvent, merge as observableMerge, of as observableOf, } from "rxjs";
import { mapTo, mergeMap, startWith, switchMapTo, take, } from "rxjs/operators";
/**
...
export default function emitSeekEvents(mediaElement, clock$) {
    return observableDefer(function () {
        ...
        var isSeeking$ = observableFromEvent(mediaElement, "seeking")
            .pipe(mapTo("seeking"));
        var hasSeeked$ = observableFromEvent(mediaElement, "seeked").pipe(switchMapTo(clock$.pipe(mergeMap(function (tick) {
