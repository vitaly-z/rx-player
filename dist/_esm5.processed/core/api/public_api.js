...
import { distinctUntilChanged, filter, map, mapTo, mergeMapTo, publish, share, skipWhile, startWith, switchMapTo, take, takeUntil, } from "rxjs/operators";
...
var Player = /** @class */ (function (_super) {
    ...
    function Player(options) {
        ...
        _this.version = /* PLAYER_VERSION */ "3.23.1";
        _this.log = log;
        _this.state = "STOPPED";
    ...
    Player.prototype.reload = function (reloadOpts) {
        var _a;
        var _b = this._priv_lastContentPlaybackInfos, options = _b.options, manifest = _b.manifest, lastPlaybackPosition = _b.lastPlaybackPosition;
        ...
        if (reloadOpts !== undefined &&
            ...
            if (this.state === "STOPPED" || this.state === "ENDED") {
                ...
                playbackPosition =
                    this.videoElement.currentTime + ((_a = window.offset) !== null && _a !== void 0 ? _a : 0);
            }
            if (reloadOpts !== undefined &&
                reloadOpts.reloadAt !== undefined &&
    ...
    Player.prototype._priv_initializeContentPlayback = function (options) {
        ...
        this._priv_contentInfos = { url: url,
            isDirectFile: isDirectFile, segmentBuffersStore: null,
            thumbnails: null,
            manifest: null,
            currentPeriod: null,
        ...
        var clock$ = createClock(videoElement, { withMediaSource: !isDirectFile, lowLatencyMode: lowLatencyMode });
        ...
        if (!isDirectFile) {
            ...
            var bufferOptions = objectAssign({ audioTrackSwitchingMode: audioTrackSwitchingMode,
                enableFastSwitching: enableFastSwitching,
                manualBitrateSwitchingMode: manualBitrateSwitchingMode,
                onCodecSwitch: onCodecSwitch }, this._priv_bufferOptions);
            ...
            var init$ = initializeMediaSourcePlayback({ adaptiveOptions: adaptiveOptions,
                ...
                clock$: clock$,
                content: { initialManifest: initialManifest,
                    manifestUpdateUrl: manifestUpdateUrl,
                    url: url },
                keySystems: keySystems,
                lowLatencyMode: lowLatencyMode, mediaElement: videoElement, minimumManifestUpdateInterval: minimumManifestUpdateInterval,
                networkConfig: networkConfig,
                transportPipelines: transportPipelines, speed$: this._priv_speed$, startAt: startAt,
            ...
            var directfileInit$ = features.directfile.initDirectFile({ autoPlay: autoPlay,
                clock$: clock$,
                keySystems: keySystems, mediaElement: videoElement,
                speed$: this._priv_speed$, startAt: startAt,
                url: url })
                .pipe(takeUntil(contentIsStopped$));
        ...
        clock$
            .pipe(takeUntil(this._priv_stopCurrentContent$))
            .subscribe(function (x) { return _this._priv_triggerPositionUpdate(x); }, noop);
        // Link "seeking" and "seeked" events (once the content is loaded)
        loaded$.pipe(switchMapTo(emitSeekEvents(this.videoElement, clock$)), takeUntil(this._priv_stopCurrentContent$)).subscribe(function (evt) {
    ...
    Player.prototype.getVideoBufferGap = function () {
        ...
        var videoElement = this.videoElement;
        return getLeftSizeOfRange(videoElement.buffered, videoElement.currentTime + ((_a = window.offset) !== null && _a !== void 0 ? _a : 0));
    };
    /**
     * Returns in seconds the difference between:
     *   - the end of the current contiguous loaded range.
    ...
    Player.prototype.getVideoLoadedTime = function () {
        ...
        var videoElement = this.videoElement;
        return getSizeOfRange(videoElement.buffered, videoElement.currentTime + ((_a = window.offset) !== null && _a !== void 0 ? _a : 0));
    };
    /**
     * Returns in seconds the difference between:
     *   - the current time.
    ...
    Player.prototype.getVideoPlayedTime = function () {
        ...
        var videoElement = this.videoElement;
        return getPlayedSizeOfRange(videoElement.buffered, videoElement.currentTime + ((_a = window.offset) !== null && _a !== void 0 ? _a : 0));
    };
    /**
    ...
    Player.prototype.getWallClockTime = function () {
        ...
        if (this._priv_contentInfos === null) {
            return this.videoElement.currentTime + ((_a = window.offset) !== null && _a !== void 0 ? _a : 0);
        }
        var _d = this._priv_contentInfos, isDirectFile = _d.isDirectFile, manifest = _d.manifest;
        if (isDirectFile) {
            return this.videoElement.currentTime + ((_b = window.offset) !== null && _b !== void 0 ? _b : 0);
        }
        if (manifest !== null) {
            var currentTime = this.videoElement.currentTime + ((_c = window.offset) !== null && _c !== void 0 ? _c : 0);
    ...
    Player.prototype.seekTo = function (time) {
        ...
        var _c = this._priv_contentInfos, isDirectFile = _c.isDirectFile, manifest = _c.manifest;
        if (!isDirectFile && manifest === null) {
        ...
        if (typeof time === "number") {
            ...
            var timeObj = time;
            var currentTs = this.videoElement.currentTime + ((_a = window.offset) !== null && _a !== void 0 ? _a : 0);
        ...
        this.videoElement.currentTime = positionWanted - ((_b = window.offset) !== null && _b !== void 0 ? _b : 0);
