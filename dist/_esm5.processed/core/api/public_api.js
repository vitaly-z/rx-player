...
var Player = /** @class */ (function (_super) {
    ...
    function Player(options) {
        ...
        _this.version = /* PLAYER_VERSION */ "3.26.0-recreatesessiononloadfalse";
        _this.log = log;
        _this.state = "STOPPED";
    ...
    Player.prototype._priv_initializeContentPlayback = function (options) {
        ...
        if (!isDirectFile) {
            ...
            var manifestFetcher = new ManifestFetcher(url, transportPipelines, { lowLatencyMode: lowLatencyMode,
...
Player.version = /* PLAYER_VERSION */ "3.26.0-recreatesessiononloadfalse";
