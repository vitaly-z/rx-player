...
var Player = /** @class */ (function (_super) {
    ...
    function Player(options) {
        ...
        _this.version = /*PLAYER_VERSION*/ "3.20.1";
        _this.log = log;
        _this.state = "STOPPED";
        ...
        _this._priv_preferredVideoTracks = new BehaviorSubject(preferredVideoTracks);
        return _this;
    }
     ...
     * @param {Array.<Object>} tracks
     */
    Player.prototype.setPreferredVideoTracks = function (tracks) {
        if (!Array.isArray(tracks)) {
