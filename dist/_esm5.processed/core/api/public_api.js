...
import { distinctUntilChanged, filter, map, mapTo, mergeMap, mergeMapTo, publish, share, shareReplay, skipWhile, startWith, switchMapTo, take, takeUntil, } from "rxjs/operators";
    ...
    Player.prototype._priv_initializeContentPlayback = function (options) {
        ...
        if (!isDirectFile) {
            ...
            var init$ = initializeMediaSourcePlayback({ adaptiveOptions: adaptiveOptions,
                ...
                segmentFetcherCreator: segmentFetcherCreator, speed$: this._priv_speed$, startAt: startAt,
