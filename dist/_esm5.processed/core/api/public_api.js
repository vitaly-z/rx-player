...
var Player = /** @class */ (function (_super) {
    ...
    function Player(options) {
        ...
        _this.version = /*PLAYER_VERSION*/ "3.18.0";
        _this.log = log;
        _this.state = "STOPPED";
    ...
    Player.prototype.loadVideo = function (opts) {
        ...
        if (!isDirectFile) {
            ...
            this._priv_mediaElementTrackChoiceManager =
                new features.directfile.mediaElementTrackChoiceManager({ preferredAudioTracks: defaultAudioTrack === undefined ?
                    ...
                    preferredTextTracks: defaultTextTrack === undefined ?
                        ...
                        new BehaviorSubject([defaultTextTrack]) }, this.videoElement);
            ...
            this.trigger("audioTrackChange", (_a = this._priv_mediaElementTrackChoiceManager.getChosenAudioTrack(), (_a !== null && _a !== void 0 ? _a : null)));
            this.trigger("textTrackChange", (_b = this._priv_mediaElementTrackChoiceManager.getChosenTextTrack(), (_b !== null && _b !== void 0 ? _b : null)));
            this.trigger("videoTrackChange", (_c = this._priv_mediaElementTrackChoiceManager.getChosenVideoTrack(), (_c !== null && _c !== void 0 ? _c : null)));
            this._priv_mediaElementTrackChoiceManager
    ...
    Player.prototype.getAvailableAudioTracks = function () {
        ...
        if (isDirectFile) {
            return _b = (_a = this._priv_mediaElementTrackChoiceManager) === null || _a === void 0 ? void 0 : _a.getAvailableAudioTracks(), (_b !== null && _b !== void 0 ? _b : []);
        }
    ...
    Player.prototype.getAvailableTextTracks = function () {
        ...
        var _c = this._priv_contentInfos, currentPeriod = _c.currentPeriod, isDirectFile = _c.isDirectFile;
        if (isDirectFile) {
            return _b = (_a = this._priv_mediaElementTrackChoiceManager) === null || _a === void 0 ? void 0 : _a.getAvailableTextTracks(), (_b !== null && _b !== void 0 ? _b : []);
        }
        if (this._priv_trackChoiceManager === null || currentPeriod === null) {
            return [];
        }
    ...
    Player.prototype.getAvailableVideoTracks = function () {
        ...
        var _c = this._priv_contentInfos, currentPeriod = _c.currentPeriod, isDirectFile = _c.isDirectFile;
        if (isDirectFile) {
            return _b = (_a = this._priv_mediaElementTrackChoiceManager) === null || _a === void 0 ? void 0 : _a.getAvailableVideoTracks(), (_b !== null && _b !== void 0 ? _b : []);
        }
        if (this._priv_trackChoiceManager === null || currentPeriod === null) {
            return [];
        }
    ...
    Player.prototype._priv_onActivePeriodChanged = function (_a) {
        ...
        var audioBitrate = (_d = (_c = (_b = this.getCurrentRepresentations()) === null || _b === void 0 ? void 0 : _b.audio) === null || _c === void 0 ? void 0 : _c.bitrate, (_d !== null && _d !== void 0 ? _d : -1));
        this._priv_triggerCurrentBitrateChangeEvent("audioBitrateChange", audioBitrate);
        var videoBitrate = (_g = (_f = (_e = this.getCurrentRepresentations()) === null || _e === void 0 ? void 0 : _e.video) === null || _f === void 0 ? void 0 : _f.bitrate, (_g !== null && _g !== void 0 ? _g : -1));
    ...
    Player.prototype._priv_onRepresentationChange = function (_a) {
        ...
        var _e = this._priv_contentInfos, activeRepresentations = _e.activeRepresentations, currentPeriod = _e.currentPeriod;
        var activePeriodRepresentations = activeRepresentations[period.id];
        ...
        var bitrate = (_d = (_c = representation) === null || _c === void 0 ? void 0 : _c.bitrate, (_d !== null && _d !== void 0 ? _d : -1));
