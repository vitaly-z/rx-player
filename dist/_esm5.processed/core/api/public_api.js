...
var Player = /** @class */ (function (_super) {
    ...
    function Player(options) {
        ...
        _this.version = /*PLAYER_VERSION*/ "3.21.1";
        _this.log = log;
        _this.state = "STOPPED";
    ...
    Player.prototype.loadVideo = function (opts) {
        ...
        this._priv_contentInfos = { url: url,
            isDirectFile: isDirectFile, sourceBuffersStore: null,
            thumbnails: null,
            manifest: null,
            currentPeriod: null,
        ...
        if (!isDirectFile) {
            ...
            var bufferOptions = objectAssign({ manualBitrateSwitchingMode: manualBitrateSwitchingMode,
                audioTrackSwitchingMode: audioTrackSwitchingMode }, this._priv_bufferOptions);
            ...
            var init$ = initializeMediaSourcePlayback({ adaptiveOptions: adaptiveOptions,
                ...
                lowLatencyMode: lowLatencyMode,
                manifestUpdateUrl: manifestUpdateUrl, mediaElement: videoElement, minimumManifestUpdateInterval: minimumManifestUpdateInterval,
    ...
    Player.prototype.__priv_getSourceBufferContent = function (bufferType) {
        ...
        var sourceBufferStatus = this._priv_contentInfos
