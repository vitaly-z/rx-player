 ...
 */
import { combineLatest as observableCombineLatest, concat as observableConcat, connectable, distinctUntilChanged, EMPTY, filter, map, mapTo, merge as observableMerge, mergeMap, mergeMapTo, of as observableOf, ReplaySubject, share, shareReplay, skipWhile, startWith, Subject, switchMapTo, take, takeUntil, } from "rxjs";
...
var Player = /** @class */ (function (_super) {
    ...
    function Player(options) {
        ...
        _this.version = /* PLAYER_VERSION */ "3.26.1";
        _this.log = log;
        _this.state = "STOPPED";
    ...
    Player.prototype._priv_initializeContentPlayback = function (options) {
        ...
        loaded$.pipe(switchMapTo(emitSeekEvents(this.videoElement, observation$)), takeUntil(stopContent$)).subscribe(function (evt) {
