...
var Player = /** @class */ (function (_super) {
    ...
    function Player(options) {
        ...
        _this.version = /* PLAYER_VERSION */ "3.24.0";
        _this.log = log;
        _this.state = "STOPPED";
    ...
    Player.prototype._priv_initializeContentPlayback = function (options) {
        ...
        if (!isDirectFile) {
            ...
            var init$ = initializeMediaSourcePlayback({ adaptiveOptions: adaptiveOptions,
                ...
                lowLatencyMode: lowLatencyMode,
                manifest$: manifest$,
                manifestFetcher: manifestFetcher, mediaElement: videoElement, minimumManifestUpdateInterval: minimumManifestUpdateInterval,
                segmentFetcherCreator: segmentFetcherCreator,
                setCurrentTime: setCurrentTime, speed$: this._priv_speed$, startAt: startAt,
