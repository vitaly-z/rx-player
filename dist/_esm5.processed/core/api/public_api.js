...
var Player = /** @class */ (function (_super) {
    ...
    function Player(options) {
        ...
        _this.version = /* PLAYER_VERSION */ "3.26.2-checkmediacap";
        _this.log = log;
        _this.state = "STOPPED";
    ...
    Player.prototype._priv_initializeContentPlayback = function (options) {
        ...
        if (!isDirectFile) {
            ...
            if (!isNullOrUndefined(initialManifest)) {
                ...
                if (typeof initialManifest.getPeriodForTime === "function") {
...
Player.version = /* PLAYER_VERSION */ "3.26.2-checkmediacap";
