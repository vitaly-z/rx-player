 ...
 */
import { combineLatest as observableCombineLatest, concat as observableConcat, connectable, EMPTY, merge as observableMerge, of as observableOf, ReplaySubject, Subject, } from "rxjs";
...
var Player = /** @class */ (function (_super) {
    ...
    Player.prototype._priv_initializeContentPlayback = function (options) {
        ...
        var playback$;
        var speed$ = this._priv_speed.asObservable().pipe(distinctUntilChanged());
        if (!isDirectFile) {
            ...
            var directfileInit$ = features.directfile.initDirectFile({ autoPlay: autoPlay, clock$: clock$, keySystems: keySystems, mediaElement: videoElement, speed$: speed$, startAt: startAt, setCurrentTime: setCurrentTime, url: url })
                .pipe(takeUntil(stopContent$));
