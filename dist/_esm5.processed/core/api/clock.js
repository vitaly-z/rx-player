...
function getMediaInfos(mediaElement, currentState) {
    ...
    return { bufferGap: getLeftSizeOfRange(buffered, currentTime), buffered: buffered, currentRange: getRange(buffered, currentTime),
...
function createClock(mediaElement, options) {
    return observableDefer(function () {
        ...
        function getCurrentClockTick(state) {
            ...
            return objectAssign({}, mediaTimings, { stalled: stalledState, getCurrentTime: function () { return mediaElement.currentTime; } });
        }
