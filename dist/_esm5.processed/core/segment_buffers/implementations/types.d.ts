...
import SegmentInventory, { IBufferedChunk, IBufferedHistoryElement, IChunkContext, IInsertedChunkInfos } from "../inventory";
/**
 ...
 * array.
 */
export declare abstract class SegmentBuffer<T> {
     ...
     * @returns {Observable}
     */
    abstract pushChunk(infos: IPushChunkInfos<T>): Observable<void>;
    /**
     ...
     * @returns {Observable}
     */
    abstract removeBuffer(start: number, end: number): Observable<void>;
    /**
     ...
     * @returns {Observable}
     */
    abstract endOfSegment(infos: IEndOfSegmentInfos): Observable<void>;
    /**
