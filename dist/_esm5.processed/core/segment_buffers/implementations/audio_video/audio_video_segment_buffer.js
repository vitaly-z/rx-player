...
var AudioVideoSegmentBuffer = /** @class */ (function (_super) {
    ...
    AudioVideoSegmentBuffer.prototype._preparePushOperation = function (data) {
        ...
        var _timestampOffset = (timestampOffset !== null && timestampOffset !== void 0 ? timestampOffset : 0) - ((_a = window.offset) !== null && _a !== void 0 ? _a : 0);
        if (this._sourceBuffer.timestampOffset !== _timestampOffset) {
            var newTimestampOffset = _timestampOffset;
        ...
        if (appendWindow[0] === undefined) {
            ...
            if (appendWindow[0] >= this._sourceBuffer.appendWindowEnd) {
                this._sourceBuffer.appendWindowEnd = appendWindow[0] + 1 - ((_b = window.offset) !== null && _b !== void 0 ? _b : 0);
            }
            this._sourceBuffer.appendWindowStart = appendWindow[0] - ((_c = window.offset) !== null && _c !== void 0 ? _c : 0);
        }
        if (appendWindow[1] === undefined) {
            ...
            this._sourceBuffer.appendWindowEnd = appendWindow[1] - ((_d = window.offset) !== null && _d !== void 0 ? _d : 0);
        }
