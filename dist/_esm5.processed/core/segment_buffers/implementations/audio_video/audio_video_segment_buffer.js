...
import { fakeEncryptionDataInInitSegment, } from "../../../../parsers/containers/isobmff/utils";
...
var AudioVideoSegmentBuffer = /** @class */ (function (_super) {
    ...
    AudioVideoSegmentBuffer.prototype.dispose = function () {
        ...
        if (this._mediaSource.readyState === "open") {
            try {
                ...
                log.warn("AVSB: Failed to abort a ".concat(this.bufferType, " SourceBuffer:"), e instanceof Error ? e : "");
            }
        }
    };
    /**
    ...
    AudioVideoSegmentBuffer.prototype._preparePushOperation = function (data) {
        ...
        if (data.initSegment !== null &&
            ...
            var segmentData = fakeEncryptionDataInInitSegment(data.initSegment);
