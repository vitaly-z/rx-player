 ...
 * @returns {Promise}
 */
export default function createOrLoadSession(initializationData, stores, wantedSessionType, maxSessionCacheSize, cancelSignal) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (entry !== null) {
                        ...
                        if (isSessionUsable(previousLoadedSession)) {
                            ...
                            return [2 /*return*/, { type: "loaded-open-session" /* LoadedOpenSession */,
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2: return [4 /*yield*/, cleanOldLoadedSessions(loadedSessionsStore, maxSessionCacheSize)];
                case 3:
                    _a.sent();
                    if (cancelSignal.cancellationError !== null) {
                        throw cancelSignal.cancellationError; // stop here if cancelled since
