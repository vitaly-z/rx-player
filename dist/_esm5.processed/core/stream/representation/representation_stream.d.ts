 ...
 * @returns {Observable}
 */
export default function RepresentationStream<TSegmentDataType>({ clock$, content, segmentBuffer, segmentFetcher, terminate$, options, }: IRepresentationStreamArguments<TSegmentDataType>): Observable<IRepresentationStreamEvent>;
