 ...
 * @returns {Observable}
 */
export default function appendSegmentToBuffer(clock$, segmentBuffer, dataInfos) {
    ...
    return append$.pipe(catchError(function (appendError) {
        ...
        return observableConcat(forceGarbageCollection(clock$, segmentBuffer).pipe(ignoreElements()), append$).pipe(catchError(function (forcedGCError) {
