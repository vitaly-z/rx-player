...
import { IBufferedChunk, SegmentBuffer } from "../../segment_buffers";
 ...
 */
export default function getNeededSegments({ content, currentPlaybackTime, fastSwitchThreshold, neededRange, segmentsBeingPushed, bufferedSegments, segmentBuffer, }: IGetNeededSegmentsArguments): ISegment[];
