 ...
 */
export default function getNeededSegments({ content, currentPlaybackTime, knownStableBitrate, neededRange, queuedSourceBuffer, }: ISegmentFilterArgument): ISegment[];
