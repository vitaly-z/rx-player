...
export default function getNeededSegments(_a) {
    var content = _a.content, currentPlaybackTime = _a.currentPlaybackTime, fastSwitchThreshold = _a.fastSwitchThreshold, neededRange = _a.neededRange, segmentsBeingPushed = _a.segmentsBeingPushed, bufferedSegments = _a.bufferedSegments, segmentBuffer = _a.segmentBuffer;
    ...
    var segmentsToKeep = bufferedSegments
        ...
        if (isStartGarbageCollected(currentSeg, prevSeg, neededRange.start)) {
            ...
            for (var elementIdx = elements.length - 1; elementIdx >= 0; elementIdx--) {
                ...
                if (element.type === 0 /* InitialBufferedStart */) {
        ...
        if (isEndGarbageCollected(currentSeg, nextSeg, neededRange.start)) {
            ...
            for (var elementIdx = elements.length - 1; elementIdx >= 0; elementIdx--) {
                var element = elements[elementIdx];
                if (element.type === 1 /* InitialBufferedEnd */) {
