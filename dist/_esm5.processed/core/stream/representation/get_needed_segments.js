...
export default function getNeededSegments(_a) {
    var content = _a.content, currentPlaybackTime = _a.currentPlaybackTime, fastSwitchThreshold = _a.fastSwitchThreshold, neededRange = _a.neededRange, segmentBuffer = _a.segmentBuffer;
    var segmentInventory = segmentBuffer.getInventory();
    /**
