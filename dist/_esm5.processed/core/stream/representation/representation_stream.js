...
export default function RepresentationStream(_a) {
    var bufferGoal$ = _a.bufferGoal$, clock$ = _a.clock$, content = _a.content, fastSwitchThreshold$ = _a.fastSwitchThreshold$, queuedSourceBuffer = _a.queuedSourceBuffer, segmentFetcher = _a.segmentFetcher, terminate$ = _a.terminate$;
    ...
    var status$ = observableCombineLatest([
    ...
    ]).pipe(withLatestFrom(fastSwitchThreshold$), map(function getCurrentStatus(_a) {
        var _b = _a[0], timing = _b[0], bufferGoal = _b[1], terminate = _b[2], fastSwitchThreshold = _a[1];
        ...
        if (!representation.index.isInitialized()) {
            ...
            neededSegments = getNeededSegments({ content: content, currentPlaybackTime: timing.currentTime, fastSwitchThreshold: fastSwitchThreshold,
