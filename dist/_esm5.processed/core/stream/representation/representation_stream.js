...
export default function RepresentationStream(_a) {
    ...
    var status$ = observableCombineLatest([
        ...
        var _b, _c;
        var _d = _a[0], observation = _d[0], bufferGoal = _d[1], maxBufferSize = _d[2], terminate = _d[3], fastSwitchThreshold = _a[1];
        var initialWantedTime = (_b = observation.position.pending) !== null && _b !== void 0 ? _b : observation.position.last;
        ...
        if (!representation.index.isInitialized()) {
            if (initSegmentState.segment === null) {
                ...
                var wantedStart = (_c = observation.position.pending) !== null && _c !== void 0 ? _c : observation.position.last;
        ...
        var bufferStatusEvt = observableOf({ type: "stream-status",
            value: { period: period, position: observation.position.last, bufferType: bufferType, imminentDiscontinuity: status.imminentDiscontinuity,
