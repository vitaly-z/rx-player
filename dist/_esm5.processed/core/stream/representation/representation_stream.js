    ...
    function onLoaderEvent(evt) {
        ...
        switch (evt.type) {
            ...
            case "parsed-segment":
                ...
                var _b = evt.value, inbandEvents = _b.inbandEvents, needsManifestRefresh = _b.needsManifestRefresh;
                ...
                var inbandEvents$ = inbandEvents !== undefined &&
                    ...
                    observableOf({ type: "inband-events", value: inbandEvents }) :
                    EMPTY;
                return observableConcat(manifestRefresh$, inbandEvents$, pushMediaSegment({ clock$: clock$,
                    content: content,
