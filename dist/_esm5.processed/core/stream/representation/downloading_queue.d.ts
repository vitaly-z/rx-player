...
export default class DownloadingQueue<T> {
     ...
     * media segment.
     */
    constructor(content: IDownloadingQueueContext, downloadQueue$: BehaviorSubject<IDownloadQueueItem>, segmentFetcher: IPrioritizedSegmentFetcher<T>, hasInitSegment: boolean);
    /**
