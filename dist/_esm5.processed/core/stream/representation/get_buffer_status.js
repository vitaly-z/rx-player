...
export default function getBufferStatus(content, tick, fastSwitchThreshold, bufferGoal, segmentBuffer) {
    ...
    var neededSegments = getNeededSegments({ content: content, bufferedSegments: bufferedSegments, currentPlaybackTime: tick.getCurrentTime(), fastSwitchThreshold: fastSwitchThreshold, getBufferedHistory: getBufferedHistory, neededRange: neededRange, segmentsBeingPushed: segmentsBeingPushed })
