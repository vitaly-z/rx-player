 ...
 * @returns {Observable}
 */
export default function reloadAfterSwitch(period, bufferType, clock$, deltaPos) {
    return clock$.pipe(map(function (tick) {
        ...
        return EVENTS.waitingMediaSourceReload(bufferType, period, reloadAt, !tick.isPaused);
    }));
}
