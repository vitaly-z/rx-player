 ...
 * @returns {Observable}
 */
export default function reloadAfterSwitch(period: IPeriod, bufferType: IBufferType, playbackObserver: IReadOnlyPlaybackObserver<{
    position: number;
    isPaused: boolean;
}>, deltaPos: number): Observable<IWaitingMediaSourceReloadInternalEvent>;
