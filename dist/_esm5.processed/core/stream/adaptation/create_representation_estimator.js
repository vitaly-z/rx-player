...
export default function createRepresentationEstimator(_a, abrManager, observation$) {
    ...
    observableOf(null)).pipe(map(function () {
        ...
        return abrManager.get$(adaptation.type, playableRepresentations, observation$, abrEvents$);
    }));
    return { estimator$: estimator$, streamFeedback$: streamFeedback$, requestFeedback$: requestFeedback$ };
}
