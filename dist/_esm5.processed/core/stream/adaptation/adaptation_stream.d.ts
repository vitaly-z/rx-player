 ...
 * @returns {Observable}
 */
export default function AdaptationStream({ abrManager, clock$, content, options, segmentBuffer, segmentFetcherCreator, wantedBufferAhead$, }: IAdaptationStreamArguments): Observable<IAdaptationStreamEvent>;
