...
var EVENTS = {
    ...
    needsMediaSourceReload: function (period, _a) {
        ...
        return { type: "needs-media-source-reload", value: { position: position, isPaused: isPaused, period: period } };
    },
    needsDecipherabilityFlush: function (_a) {
        var position = _a.position, isPaused = _a.isPaused, duration = _a.duration;
        return { type: "needs-decipherability-flush", value: { position: position, isPaused: isPaused, duration: duration } };
    },
