...
export default function PeriodStream(_a) {
    ...
    function createAdaptationStream(adaptation, segmentBuffer) {
        ...
        return AdaptationStream({ abrManager: abrManager, clock$: adaptationStreamClock$,
            content: { manifest: manifest, period: period, adaptation: adaptation }, options: options, segmentBuffer: segmentBuffer, segmentFetcherCreator: segmentFetcherCreator, wantedBufferAhead$: wantedBufferAhead$ }).pipe(catchError(function (error) {
