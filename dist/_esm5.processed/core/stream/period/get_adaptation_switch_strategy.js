 ...
 * @returns {Object}
 */
export default function getAdaptationSwitchStrategy(queuedSourceBuffer, period, adaptation, playbackInfo, audioTrackSwitchingMode) {
    ...
    if (adaptation.type === "video" &&
        ...
        (playbackInfo.readyState > 1 || !adaptation.getPlayableRepresentations()
            .some(function (rep) {
            var _a;
            return areCodecsCompatible(rep.getMimeTypeString(), (_a = queuedSourceBuffer.codec) !== null && _a !== void 0 ? _a : "");
        })) &&
