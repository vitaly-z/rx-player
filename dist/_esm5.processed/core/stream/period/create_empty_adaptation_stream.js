 ...
 * @returns {Observable}
 */
export default function creatEmptyAdaptationStream(streamClock$, wantedBufferAhead$, bufferType, content) {
    var period = content.period;
    return observableCombineLatest([streamClock$, wantedBufferAhead$]).pipe(filter(function (_a) {
