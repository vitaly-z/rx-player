...
export declare type IRepresentationStreamEvent<T> = IStreamStatusEvent | IStreamEventAddedSegment<T> | IEncryptionDataEncounteredEvent | IStreamManifestMightBeOutOfSync | IStreamTerminatingEvent | IStreamNeedsManifestRefresh | IStreamWarningEvent;
