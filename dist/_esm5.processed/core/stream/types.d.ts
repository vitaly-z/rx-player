...
export declare type IPeriodStreamEvent = IPeriodStreamReadyEvent | IAdaptationStreamEvent<unknown> | INeedsMediaSourceReload | IAdaptationChangeEvent | IAddedSegmentOnAdaptationChange;
/** Event coming from function(s) managing multiple PeriodStreams. */
export declare type IMultiplePeriodStreamsEvent = IPeriodStreamEvent | IPeriodStreamClearedEvent | ICompletedStreamEvent;
/** Every event sent by the `StreamOrchestrator`. */
export declare type IStreamOrchestratorEvent = IActivePeriodChangedEvent | IMultiplePeriodStreamsEvent | IEndOfStreamEvent | IResumeStreamEvent;
