...
export declare type IAdaptationStreamEvent<T> = IRepresentationStreamEvent<T> | IBitrateEstimationChangeEvent | INeedsMediaSourceReload | INeedsDecipherabilityFlush | IRepresentationChangeEvent;
/**
...
export declare type IPeriodStreamEvent = IPeriodStreamReadyEvent | IAdaptationStreamEvent<unknown> | INeedsMediaSourceReload | IAdaptationChangeEvent;
/** Event coming from function(s) managing multiple PeriodStreams. */
export declare type IMultiplePeriodStreamsEvent = IPeriodStreamEvent | IPeriodStreamClearedEvent | INeedsMediaSourceReload | ICompletedStreamEvent;
/** Every event sent by the `StreamOrchestrator`. */
export declare type IStreamOrchestratorEvent = IActivePeriodChangedEvent | IMultiplePeriodStreamsEvent | IEndOfStreamEvent | INeedsMediaSourceReload | IResumeStreamEvent;
