...
export declare type IRepresentationStreamEvent<T> = IStreamStatusEvent | IStreamEventAddedSegment<T> | IProtectedSegmentEvent | IStreamManifestMightBeOutOfSync | IStreamTerminatingEvent | IStreamNeedsManifestRefresh | IStreamWarningEvent;
/** Event sent by an `AdaptationStream`. */
export declare type IAdaptationStreamEvent<T> = IBitrateEstimationChangeEvent | INeedsMediaSourceReload | INeedsDecipherabilityFlush | IRepresentationChangeEvent | IStreamStatusEvent | IStreamEventAddedSegment<T> | IProtectedSegmentEvent | IStreamManifestMightBeOutOfSync | IStreamNeedsManifestRefresh | IStreamWarningEvent;
/** Event sent by a `PeriodStream`. */
export declare type IPeriodStreamEvent = IPeriodStreamReadyEvent | INeedsMediaSourceReload | IAdaptationChangeEvent | IBitrateEstimationChangeEvent | INeedsMediaSourceReload | INeedsDecipherabilityFlush | IRepresentationChangeEvent | IStreamStatusEvent | IStreamEventAddedSegment<unknown> | IProtectedSegmentEvent | IStreamManifestMightBeOutOfSync | IStreamNeedsManifestRefresh | IStreamWarningEvent;
