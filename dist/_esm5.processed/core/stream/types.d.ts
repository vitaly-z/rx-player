...
export declare type IRepresentationStreamEvent<T> = IStreamEventAddedSegment<T> | IProtectedSegmentEvent | IStreamStateFull | IStreamStateActive | IStreamManifestMightBeOutOfSync | IStreamNeedsDiscontinuitySeek | IStreamNeedsManifestRefresh | IStreamWarningEvent;
