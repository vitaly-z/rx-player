 ...
 */
export interface ICompletedStreamEvent {
...
export declare type IRepresentationStreamEvent<T> = IStreamEventAddedSegment<T> | IProtectedSegmentEvent | IStreamStateFull | IStreamStateActive | IStreamManifestMightBeOutOfSync | IStreamNeedsDiscontinuitySeek | IStreamNeedsManifestRefresh | IStreamTerminatingEvent | IStreamWarningEvent;
/** Event sent by an `AdaptationStream`. */
export declare type IAdaptationStreamEvent<T> = IBitrateEstimationChangeEvent | INeedsMediaSourceReload | INeedsDecipherabilityFlush | IRepresentationChangeEvent | IStreamEventAddedSegment<T> | IProtectedSegmentEvent | IStreamStateFull | IStreamStateActive | IStreamManifestMightBeOutOfSync | IStreamNeedsDiscontinuitySeek | IStreamNeedsManifestRefresh | IStreamWarningEvent;
/** Event sent by a `PeriodStream`. */
export declare type IPeriodStreamEvent = IPeriodStreamReadyEvent | INeedsMediaSourceReload | IAdaptationChangeEvent | IBitrateEstimationChangeEvent | INeedsMediaSourceReload | INeedsDecipherabilityFlush | IRepresentationChangeEvent | IStreamEventAddedSegment<unknown> | IProtectedSegmentEvent | IStreamStateFull | IStreamStateActive | IStreamManifestMightBeOutOfSync | IStreamNeedsDiscontinuitySeek | IStreamNeedsManifestRefresh | IStreamWarningEvent;
/** Event coming from function(s) managing multiple PeriodStreams. */
export declare type IMultiplePeriodStreamsEvent = IPeriodStreamClearedEvent | ICompletedStreamEvent | IPeriodStreamReadyEvent | INeedsMediaSourceReload | IAdaptationChangeEvent | IBitrateEstimationChangeEvent | INeedsMediaSourceReload | INeedsDecipherabilityFlush | IRepresentationChangeEvent | IStreamEventAddedSegment<unknown> | IProtectedSegmentEvent | IStreamStateActive | IStreamManifestMightBeOutOfSync | IStreamNeedsDiscontinuitySeek | IStreamNeedsManifestRefresh | IStreamWarningEvent;
