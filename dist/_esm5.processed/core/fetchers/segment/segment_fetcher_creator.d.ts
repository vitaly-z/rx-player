...
import { ISegmentFetcherCreatorCallbacks } from "./segment_fetcher";
/**
...
export default class SegmentFetcherCreator {
     ...
     * @returns {Object}
     */
    createSegmentFetcher(bufferType: IBufferType, callbacks: ISegmentFetcherCreatorCallbacks): IPrioritizedSegmentFetcher<unknown>;
}
