...
import { ISegmentParserParsedInitSegment, ISegmentParserParsedSegment, ISegmentPipeline } from "../../../transports";
...
export interface ISegmentFetcherChunkEvent<TSegmentDataType> {
     ...
     * @returns {Object}
     */
    parse(initTimescale?: number): ISegmentParserParsedInitSegment<TSegmentDataType> | ISegmentParserParsedSegment<TSegmentDataType>;
}
/**
 ...
 * @returns {Function}
 */
export default function createSegmentFetcher<LoadedFormat, TSegmentDataType>(bufferType: IBufferType, segmentPipeline: ISegmentPipeline<LoadedFormat, TSegmentDataType>, requests$: Subject<IABRMetricsEvent | IABRRequestBeginEvent | IABRRequestProgressEvent | IABRRequestEndEvent>, options: IBackoffOptions): ISegmentFetcher<TSegmentDataType>;
