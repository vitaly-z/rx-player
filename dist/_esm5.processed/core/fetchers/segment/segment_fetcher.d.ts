...
import { ISegmentParserInitSegment, ISegmentParserSegment, ITransportPipelines } from "../../../transports";
...
export interface ISegmentFetcherChunkEvent<T> {
    ...
    parse: (initTimescale?: number) => Observable<ISegmentParserInitSegment<T> | ISegmentParserSegment<T>>;
}
/**
