...
export default class ObservablePrioritizer<T> {
     ...
     * @private
     */
    private _pendingPriority;
    /**
     * Number of Observables currently running.
     * @type {Number|null}
     * @private
     */
    private _numberOfPendingObservables;
    /**
     ...
     * @returns {Observable}
     */
    create(obs: Observable<T>, priority: number): Observable<T>;
    /**
     ...
     * @param {number} priority
     */
    updatePriority(obs: Observable<T>, priority: number): void;
