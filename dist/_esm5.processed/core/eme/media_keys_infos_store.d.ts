 ...
 */
import { ICompatMediaKeySystemAccess, ICustomMediaKeys, ICustomMediaKeySystemAccess } from "../../compat";
import { IKeySystemOption } from "./types";
import SessionsStore from "./utils/open_sessions_store";
export declare type IMediaElementMediaKeysInfos = {
...
declare const _default: {
     ...
     * @param {Object} state
     */
    setState(mediaElement: HTMLMediaElement, state: IMediaElementMediaKeysInfos): void;
    /**
