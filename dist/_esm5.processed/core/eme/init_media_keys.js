    ...
    return getMediaKeysInfos(mediaElement, keySystemsConfigs)
        ...
        return disableOldMediaKeys$.pipe(mergeMap(function () {
            ...
            return attachMediaKeys$.pipe(mergeMap(function () {
                ...
                value: { mediaKeySystemAccess: mediaKeySystemAccess, initializationDataSystemId: initializationDataSystemId, mediaKeys: mediaKeys, stores: stores, options: options, attachMediaKeys$: attachMediaKeys$ } }));
        }));
    }));
}
