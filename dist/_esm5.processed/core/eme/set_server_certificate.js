...
export default function trySettingServerCertificate(mediaKeys, serverCertificate) {
    return observableDefer(function () {
        ...
        return setServerCertificate(mediaKeys, serverCertificate).pipe(tap(function () { ServerCertificateStore.set(mediaKeys, serverCertificate); }), ignoreElements(), catchError(function (error) { return observableOf({
            type: "warning",
