 ...
 * @returns {Observable}
 */
export default function createSession(initData: Uint8Array, initDataType: string | undefined, mediaKeysInfos: IMediaKeysInfos, forceNonPersistence: boolean): Observable<ICreateSessionEvent>;
