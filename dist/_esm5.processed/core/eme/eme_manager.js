...
export default function EMEManager(mediaElement, keySystemsConfigs, contentProtections$) {
    ...
    mergeMap(function (sessionInfosEvt) {
        ...
        var _a = sessionInfosEvt.value, initData = _a.initData, initDataType = _a.initDataType, mediaKeySession = _a.mediaKeySession, sessionType = _a.sessionType, keySystemOptions = _a.keySystemOptions, persistentSessionsStore = _a.persistentSessionsStore;
