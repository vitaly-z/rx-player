...
function buildKeySystemConfigurations(ksName, keySystem) {
    ...
    var videoCapabilities = flatMap(videoRobustnesses, function (robustness) { return [{ contentType: "video/mp4;codecs=\"avc1.4d401e\"",
            robustness: robustness },
        { contentType: "video/mp4;codecs=\"avc1.42e01e\"",
            robustness: robustness },
        { contentType: "video/webm;codecs=\"vp8\"",
            robustness: robustness }]; });
    var audioCapabilities = flatMap(audioRobustnesses, function (robustness) { return [{ contentType: "audio/mp4;codecs=\"mp4a.40.2\"",
            robustness: robustness },
        ...
        return new Observable(function (obs) {
            ...
            function testKeySystem(index) {
                ...
                if (index >= keySystemsType.length) {
                    obs.error(new EncryptedMediaError("INCOMPATIBLE_KEYSYSTEMS", "No key system compatible with your " +
