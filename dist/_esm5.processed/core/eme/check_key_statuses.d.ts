 ...
 */
export default function checkKeyStatuses(session: MediaKeySession | ICustomMediaKeySession, keySystemOptions: IKeySystemOption, keySystem: string): [IEMEWarningEvent[], ArrayBuffer[]];
