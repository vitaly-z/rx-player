...
export default class InitDataStore<T> {
     ...
     * @returns {*}
     */
    get(initData: Uint8Array, initDataType: string | undefined): T | undefined;
    /**
     ...
     * @returns {*}
     */
    getAndReuse(initData: Uint8Array, initDataType: string | undefined): T | undefined;
    /**
     ...
     * @returns {boolean}
     */
    store(initData: Uint8Array, initDataType: string | undefined, value: T): void;
    /**
     * Add to the store a value linked to the corresponding initData and
     * initDataType.
     ...
     * @returns {boolean}
     */
    storeIfNone(initData: Uint8Array, initDataType: string | undefined, value: T): boolean;
    /**
     ...
     * @returns {*}
     */
    remove(initData: Uint8Array, initDataType: string | undefined): T | undefined;
    /**
