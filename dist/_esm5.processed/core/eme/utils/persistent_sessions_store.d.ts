...
import { IInitializationDataInfo, IPersistentSessionInfo, IPersistentSessionStorage } from "../types";
/**
...
export default class PersistentSessionsStore {
     ...
     * @returns {Object|null}
     */
    get(initData: IInitializationDataInfo): IPersistentSessionInfo | null;
    /**
     ...
     * @returns {*}
     */
    getAndReuse(initData: IInitializationDataInfo): IPersistentSessionInfo | null;
    /**
     ...
     */
    add(initData: IInitializationDataInfo, session: MediaKeySession | ICustomMediaKeySession): void;
    /**
