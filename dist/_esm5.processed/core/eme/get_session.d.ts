 ...
 * @returns {Observable}
 */
export default function getSession(initializationData: IInitializationDataInfo, stores: IMediaKeySessionStores, wantedSessionType: MediaKeySessionType, maxSessionCacheSize: number): Observable<IGetSessionEvent>;
