 ...
 * @returns {Observable}
 */
export default function getSession(initializationDataInfo: IInitializationDataInfo, mediaKeysInfos: IMediaKeysInfos, forceNonPersistence: boolean): Observable<IGetSessionEvent>;
