...
export function mockCompat(exportedFunctions) {
    ...
    return { eventSpies: eventSpies,
        eventTriggers: { triggerEncrypted: triggerEncrypted,
            ...
            triggerKeyStatusesChange: triggerKeyStatusesChange },
        requestMediaKeySystemAccessSpy: rmksaSpy,
        getInitDataSpy: getInitDataSpy,
 ...
 */
export function expectLicenseRequestMessage(evt, initDataVal) {
 ...
 */
export function expectInitDataIgnored(evt, initDataVal) {
 ...
 * @param {string|undefined} initDataType
 */
export function expectEncryptedEventReceived(evt, initData) {
