...
export function mockCompat(exportedFunctions) {
    ...
    return { eventSpies: eventSpies, eventTriggers: { triggerEncrypted: triggerEncrypted, triggerKeyMessage: triggerKeyMessage, triggerKeyError: triggerKeyError, triggerKeyStatusesChange: triggerKeyStatusesChange },
