...
var BandwidthEstimator = /** @class */ (function () {
    function BandwidthEstimator() {
        var _a = config.getCurrent(), ABR_FAST_EMA = _a.ABR_FAST_EMA, ABR_SLOW_EMA = _a.ABR_SLOW_EMA;
        /**
    ...
    BandwidthEstimator.prototype.addSample = function (durationInMs, numberOfBytes) {
        var ABR_MINIMUM_CHUNK_SIZE = config.getCurrent().ABR_MINIMUM_CHUNK_SIZE;
    ...
    BandwidthEstimator.prototype.getEstimate = function () {
        var ABR_MINIMUM_TOTAL_BYTES = config.getCurrent().ABR_MINIMUM_TOTAL_BYTES;
