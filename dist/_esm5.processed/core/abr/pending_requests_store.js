...
var PendingRequestsStore = /** @class */ (function () {
    ...
    PendingRequestsStore.prototype.add = function (payload) {
        var id = payload.id, segment = payload.segment, requestTimestamp = payload.requestTimestamp;
        this._currentRequests[id] = { segment: segment, requestTimestamp: requestTimestamp, progress: [] };
    };
    /**
    ...
    PendingRequestsStore.prototype.getRequests = function () {
        return objectValues(this._currentRequests)
            ...
            .sort(function (reqA, reqB) { return reqA.segment.time - reqB.segment.time; });
    };
