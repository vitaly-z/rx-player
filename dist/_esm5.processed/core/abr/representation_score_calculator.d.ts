...
export default class RepresentationScoreCalculator {
     ...
     * seconds.
     */
    addSample(representation: IRepresentation, requestDuration: number, segmentDuration: number): void;
    /**
     ...
     */
    getEstimate(representation: IRepresentation): [number, ScoreConfidenceLevel] | undefined;
    /**
     ...
     */
    getLastStableRepresentation(): IRepresentation | null;
}
