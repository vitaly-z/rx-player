...
export default function RepresentationEstimator(_a) {
    ...
    var estimate$ = observableDefer(function () {
        ...
        return manualBitrate$.pipe(switchMap(function (manualBitrate) {
            ...
            var bufferBasedEstimation$ = BufferBasedChooser(bufferBasedobservation$, bitrates)
            ...
            return observableCombineLatest([observation$,
                ...
                var _c = networkAnalyzer
                    .getBandwidthEstimate(observation, bandwidthEstimator, currentRepresentation, requests, lastEstimatedBitrate), bandwidthEstimate = _c.bandwidthEstimate, bitrateChosen = _c.bitrateChosen;
                ...
                return { bitrate: bandwidthEstimate,
                    ...
                    urgent: networkAnalyzer.isUrgent(bufferBasedBitrate, currentRepresentation, requests, observation),
                    manual: false, knownStableBitrate: knownStableBitrate };
            }));
        }));
    });
