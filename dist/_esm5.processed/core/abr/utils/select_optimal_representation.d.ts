 ...
 */
export default function selectOptimalRepresentation(representations: IRepresentation[], optimalBitrate: number, minBitrate: number, maxBitrate: number): IRepresentation;
