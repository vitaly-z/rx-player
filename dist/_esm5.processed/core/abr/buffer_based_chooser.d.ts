...
import { IBufferBasedChooserClockTick } from "./get_estimate_from_buffer_levels";
/**
 ...
 * @returns {Observable}
 */
export default function BufferBasedChooser(update$: Observable<IBufferBasedChooserClockTick>, bitrates: number[]): Observable<number | undefined>;
