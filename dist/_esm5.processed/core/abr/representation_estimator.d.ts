...
import { IAdaptation, ISegment, IRepresentation } from "../../manifest";
...
export declare type IABRRequestBeginEventValue = IPendingRequestStoreBegin;
/** Value associated with a `IABRRequestProgressEvent`. */
export declare type IABRRequestProgressEventValue = IPendingRequestStoreProgress;
