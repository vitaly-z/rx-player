...
import { IBeginRequestValue, IProgressEventValue } from "./pending_requests_store";
/**
 ...
 */
export interface IABRMetricsEvent {
    type: "metrics";
 ...
 * etc.) and Period.
 */
export declare type IABRStreamEvents = IABRAddedSegmentEvent | IABRMetricsEvent | IABRRepresentationChangeEvent | IABRRequestBeginEvent | IABRRequestProgressEvent | IABRRequestEndEvent;
 ...
 * @returns {Observable}
 */
export default function RepresentationEstimator({ bandwidthEstimator, clock$, filters$, initialBitrate, lowLatencyMode, manualBitrate$, minAutoBitrate$, maxAutoBitrate$, representations, streamEvents$, }: IRepresentationEstimatorArguments): Observable<IABREstimate>;
export {};
