...
export default class ABRManager {
     ...
     * @returns {Observable}
     */
    get$(type: IBufferType, representations: Representation[], clock$: Observable<IABRManagerClockTick>, streamEvents$: Observable<IABRStreamEvents>): Observable<IABREstimate>;
    /**
