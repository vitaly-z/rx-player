...
import { IABREstimate, IABRStreamEvents, IRepresentationEstimatorClockTick } from "./representation_estimator";
...
export default class ABRManager {
     ...
     * @returns {Observable}
     */
    get$(type: IBufferType, representations: Representation[] | undefined, clock$: Observable<IABRManagerClockTick>, streamEvents$: Observable<IABRStreamEvents>): Observable<IABREstimate>;
    /**
