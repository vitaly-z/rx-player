...
export default class GuessBasedChooser {
     ...
     * algorithm).
     */
    getGuess(representations: Representation[], observation: {
        /**
         ...
         */
        speed: number;
    }, currentRepresentation: Representation, incomingBestBitrate: number, requests: IRequestInfo[]): Representation | null;
    /**
