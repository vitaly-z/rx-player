...
export default function InitializeOnMediaSource(_a) {
    var adaptiveOptions = _a.adaptiveOptions, autoPlay = _a.autoPlay, bufferOptions = _a.bufferOptions, clock$ = _a.clock$, keySystems = _a.keySystems, lowLatencyMode = _a.lowLatencyMode, manifest$ = _a.manifest$, manifestFetcher = _a.manifestFetcher, mediaElement = _a.mediaElement, minimumManifestUpdateInterval = _a.minimumManifestUpdateInterval, segmentFetcherCreator = _a.segmentFetcherCreator, setCurrentTime = _a.setCurrentTime, speed$ = _a.speed$, startAt = _a.startAt, textTrackOptions = _a.textTrackOptions;
    ...
    var loadContent$ = observableCombineLatest([manifest$,
        ...
        var manifestUpdate$ = manifestUpdateScheduler({ initialManifest: manifestEvt, manifestFetcher: manifestFetcher,
