...
export default function InitializeOnMediaSource(_a) {
     ...
     */
    var openMediaSource$ = openMediaSource(mediaElement).pipe(
    ...
    deferSubscriptions(), share()); // Do not re-start the Observable on further parallel subscriptions
    ...
    var emeManager$ = openMediaSource$.pipe(mergeMap(function () { return createEMEManager(mediaElement, keySystems, protectedSegments$); }), 
