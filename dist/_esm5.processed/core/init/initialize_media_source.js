...
import { createManifestPipeline, SegmentPipelineCreator, } from "../pipelines";
...
export default function InitializeOnMediaSource(_a) {
    ...
    var segmentPipelineCreator = new SegmentPipelineCreator(pipelines, { lowLatencyMode: lowLatencyMode,
