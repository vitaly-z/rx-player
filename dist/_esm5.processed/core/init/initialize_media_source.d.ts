 ...
 * @returns {Observable}
 */
export default function InitializeOnMediaSource({ adaptiveOptions, autoPlay, bufferOptions, clock$, keySystems, lowLatencyMode, manifest$, manifestFetcher, manifestUpdateUrl, mediaElement, minimumManifestUpdateInterval, segmentFetcherCreator, speed$, startAt, textTrackOptions }: IInitializeArguments): Observable<IInitEvent>;
