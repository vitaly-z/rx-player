    ...
    return clock$.pipe(withLatestFrom(discontinuitiesStore$), map(function (_a) {
        ...
        if (stalledPosition !== null) {
            ...
            if (skippableDiscontinuity !== null) {
                ...
                if (realSeekTime <= (mediaElement.currentTime + ((_b = window.offset) !== null && _b !== void 0 ? _b : 0))) {
                    log.info("Init: position to seek already reached, no seeking", mediaElement.currentTime + ((_c = window.offset) !== null && _c !== void 0 ? _c : 0), realSeekTime);
                }
                else {
                    log.warn("SA: skippable discontinuity found in the stream", position, realSeekTime);
                    mediaElement.currentTime = realSeekTime - ((_d = window.offset) !== null && _d !== void 0 ? _d : 0);
        ...
        if (isPlaybackStuck(position, currentRange, state, stalled !== null)) {
            ...
            mediaElement.currentTime = position - ((_e = window.offset) !== null && _e !== void 0 ? _e : 0);
        ...
        if (nextBufferRangeGap < BUFFER_DISCONTINUITY_THRESHOLD) {
            ...
            if ((mediaElement.currentTime + ((_f = window.offset) !== null && _f !== void 0 ? _f : 0)) < seekTo) {
                log.warn("Init: discontinuity encountered inferior to the threshold", freezePosition, seekTo, BUFFER_DISCONTINUITY_THRESHOLD);
                mediaElement.currentTime = seekTo - ((_g = window.offset) !== null && _g !== void 0 ? _g : 0);
            ...
            if (period.end !== undefined && period.end <= freezePosition) {
                if (manifest.periods[i + 1].start > freezePosition &&
                    manifest.periods[i + 1].start >
                        (mediaElement.currentTime + ((_h = window.offset) !== null && _h !== void 0 ? _h : 0))) {
                    var nextPeriod = manifest.periods[i + 1];
                    mediaElement.currentTime = nextPeriod.start - ((_j = window.offset) !== null && _j !== void 0 ? _j : 0);
