...
export default function initializeDirectfileContent(_a) {
    ...
    var seekAndPlay$ = initialSeekAndPlay({ clock$: clock$, mediaElement: mediaElement, startTime: initialTime,
        mustAutoPlay: autoPlay, setCurrentTime: setCurrentTime, isDirectfile: true }).seekAndPlay$;
    ...
    }), take(1), mergeMapTo(seekAndPlay$), switchMap(function (evt) {
        if (evt.type === "warning") {
