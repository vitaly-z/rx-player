...
export default function seekAndLoadOnMediaEvents(_a) {
    var clock$ = _a.clock$, mediaElement = _a.mediaElement, startTime = _a.startTime, mustAutoPlay = _a.mustAutoPlay, setCurrentTime = _a.setCurrentTime, isDirectfile = _a.isDirectfile;
