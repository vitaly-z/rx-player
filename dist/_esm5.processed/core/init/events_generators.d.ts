 ...
 * @returns {Object}
 */
declare function manifestReady(manifest: IManifest): IManifestReadyEvent;
/**
 ...
 * @returns {Object}
 */
declare function nullRepresentation(type: IBufferType, period: IPeriod): IRepresentationChangeEvent;
/**
