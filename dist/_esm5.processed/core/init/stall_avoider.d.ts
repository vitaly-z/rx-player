 ...
 * @returns {Observable}
 */
export default function StallAvoider(playbackObserver: PlaybackObserver, manifest: IManifest | null, lockedStream$: Observable<ILockedStreamEvent>, discontinuityUpdate$: Observable<IDiscontinuityEvent>): Observable<IStalledEvent | IUnstalledEvent | IWarningEvent>;
