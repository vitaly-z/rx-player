 ...
 * @returns {Observable}
 */
export default function StallAvoider(clock$: Observable<IInitClockTick>, mediaElement: HTMLMediaElement, manifest: Manifest | null, discontinuityUpdate$: Observable<IDiscontinuityEvent>, lockedStream$: Observable<ILockedStreamEvent>, setCurrentTime: (nb: number) => void): Observable<IStalledEvent | IUnstalledEvent | IWarningEvent>;
