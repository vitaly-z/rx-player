 ...
 * @returns {Observable}
 */
export default function manifestUpdateScheduler(initialManifest: {
    manifest: Manifest;
    sendingTime?: number;
}, scheduleRefresh$: Observable<number>, fetchManifest: IManifestFetcher, minimumManifestUpdateInterval: number): Observable<never>;
