...
import { IManifestFetcherParsedResult, IManifestFetcherParserOptions, ManifestFetcher } from "../fetchers";
 ...
 * @returns {Observable}
 */
export default function manifestUpdateScheduler({ initialManifest, manifestFetcher, manifestUpdateUrl, minimumManifestUpdateInterval, scheduleRefresh$, }: IManifestUpdateSchedulerArguments): Observable<IWarningEvent>;
