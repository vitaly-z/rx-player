 ...
 * @returns {Observable}
 */
declare function streamEventsEmitter(manifest: IManifest, mediaElement: HTMLMediaElement, observation$: Observable<IPlaybackObservation>): Observable<IStreamEvent>;
