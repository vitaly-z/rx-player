 ...
 */
import { ignoreElements, startWith, tap, } from "rxjs/operators";
import log from "../../log";
...
export default function DurationUpdater(manifest, mediaSource) {
    return fromEvent(manifest, "manifestUpdate").pipe(startWith(null), tap(function () {
        ...
        var newDuration = !manifest.isLive ? maximumPosition :
