...
export default function createMediaSourceLoader(_a) {
    ...
    return function loadContentOnMediaSource(mediaSource, initialTime, autoPlay) {
        ...
        var streamObserver = createStreamPlaybackObserver(playbackObserver, { autoPlay: autoPlay, initialPlayPerformed: initialPlayPerformed, initialSeekPerformed: initialSeekPerformed, speed: speed, startTime: initialTime });
