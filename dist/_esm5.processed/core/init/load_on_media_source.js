...
export default function createMediaSourceLoader(_a) {
    var mediaElement = _a.mediaElement, manifest = _a.manifest, speed = _a.speed, bufferOptions = _a.bufferOptions, representationEstimator = _a.representationEstimator, playbackObserver = _a.playbackObserver, segmentFetcherCreator = _a.segmentFetcherCreator;
    /**
