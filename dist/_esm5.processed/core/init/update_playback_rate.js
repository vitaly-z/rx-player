 ...
 * @returns {Observable}
 */
export default function updatePlaybackRate(mediaElement, speed$, clock$) {
    var forcePause$ = clock$
        .pipe(map(function (timing) { return timing.rebuffering !== null; }), startWith(false), distinctUntilChanged());
    return forcePause$
