...
export default function manifestUpdateScheduler(_a) {
    var initialManifest = _a.initialManifest, manifestFetcher = _a.manifestFetcher, manifestUpdateUrl = _a.manifestUpdateUrl, minimumManifestUpdateInterval = _a.minimumManifestUpdateInterval, scheduleRefresh$ = _a.scheduleRefresh$;
    /**
