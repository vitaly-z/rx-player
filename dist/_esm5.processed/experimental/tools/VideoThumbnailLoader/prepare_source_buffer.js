 ...
 * @returns {Observable}
 */
export default function prepareSourceBuffer(elt, codec) {
    return openMediaSource(elt).pipe(map(function (mediaSource) {
        var segmentBuffer = new AudioVideoSegmentBuffer("video", codec, mediaSource);
