 ...
 * @returns {Observable}
 */
export default function removeBufferAroundTime$(videoElement: HTMLMediaElement, sourceBuffer: AudioVideoSegmentBuffer, time: number, margin?: number): Observable<unknown>;
