...
var VideoThumbnailLoader = /** @class */ (function () {
    ...
    VideoThumbnailLoader.prototype.setTime = function (time) {
        ...
        if (log.hasLevel("DEBUG")) {
            log.debug("VTL: Found thumbnail for time", time, segments.map(function (s) {
    ...
    VideoThumbnailLoader.prototype._startTimeSettingTask = function (contentInfos, segments, time) {
        ...
        this._currentTask = { contentInfos: contentInfos, time: time, stop: function () { return killTask$.next(); },
            promise: taskPromise };
        return taskPromise;
    };
