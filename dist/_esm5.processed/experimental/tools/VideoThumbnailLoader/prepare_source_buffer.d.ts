 ...
 */
export default function prepareSourceBuffer(videoElement: HTMLVideoElement, codec: string, cleanUpSignal: CancellationSignal): Promise<AudioVideoSegmentBuffer>;
