...
import { IContentInfos, IThumbnailLoaderSegmentParser } from "./types";
/**
 ...
 * @returns {Observable}
 */
export declare function getInitializedSourceBuffer$(contentInfos: IContentInfos, element: HTMLVideoElement, { segmentLoader, segmentParser }: {
    segmentLoader: (x: ISegmentLoaderContent) => Observable<ISegmentLoaderEvent<Uint8Array | ArrayBuffer | null>>;
