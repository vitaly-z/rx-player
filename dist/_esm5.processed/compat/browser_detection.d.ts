...
declare const isChromeCast: boolean;
...
export { isChromeCast, isEdgeChromium, isIE11, isIEOrEdge, isFirefox, isSafariDesktop, isSafariMobile, isSamsungBrowser, isTizen, };
