        ...
        if (mediaElement.webkitSupportsPresentationMode &&
            ...
            return observableFromEvent(mediaElement, "webkitpresentationmodechanged")
                .pipe(map(function () { return ({ isEnabled: mediaElement
                    .webkitPresentationMode === "picture-in-picture", pipWindow: null }); }), startWith({ isEnabled: isWebKitPIPEnabled, pipWindow: null }));
        }
...
export { isActive, isVideoVisible, videoWidth$, onPlayPause$, onTextTrackChanges$, onLoadedMetadata$, onSeeking$, onSeeked$, onEnded$, onTimeUpdate$, onFullscreenChange$, onSourceOpen$, onUpdate$, onRemoveSourceBuffers$, onEncrypted$, onKeyMessage$, onKeyAdded$, onKeyError$, onKeyStatusesChange$, onPictureInPictureEvent$, };
