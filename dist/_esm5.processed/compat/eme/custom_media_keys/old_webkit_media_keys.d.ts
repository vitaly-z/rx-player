...
export interface IOldWebkitHTMLMediaElement extends HTMLVideoElement {
    ...
    webkitAddKey: (keyType: string, key: ArrayBuffer | TypedArray | DataView, kid: ArrayBuffer | TypedArray | DataView | null, sessionId: string) => void;
}
/**
 ...
 * @returns {Boolean}
 */
export declare function isOldWebkitMediaElement(element: HTMLMediaElement | IOldWebkitHTMLMediaElement): element is IOldWebkitHTMLMediaElement;
declare class OldWebKitCustomMediaKeys implements ICustomMediaKeys {
    private readonly ks_;
