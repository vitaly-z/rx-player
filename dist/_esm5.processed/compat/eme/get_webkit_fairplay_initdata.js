 ...
 */
import { bytesToUTF16Str, itole4, le4toi, strToUTF16Array, } from "../../utils/byte_parsing";
...
export default function getWebKitFairPlayInitData(initDataBytes, serverCertificateBytes) {
    ...
    var initDataUri = bytesToUTF16Str(initData);
    var contentIdStr = startsWith(initDataUri, "skd://") ? initDataUri.substring(6) :
        initDataUri;
    var id = strToUTF16Array(contentIdStr);
    var offset = 0;
