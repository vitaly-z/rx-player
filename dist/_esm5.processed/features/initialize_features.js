...
export default function initializeFeaturesObject() {
    ...
    var HAS_NATIVE_MODE = 0 /* NATIVE_VTT */ ||
        0 /* NATIVE_SAMI */ ||
        0 /* NATIVE_TTML */ ||
        0 /* NATIVE_SRT */;
    if (0 /* SMOOTH */ === 1 /* IS_ENABLED */) {
        features.transports.smooth = require("../transports/smooth/index.ts").default;
    }
    if (0 /* DASH */ === 1 /* IS_ENABLED */) {
