...
export default function initializeFeaturesObject() {
    ...
    if (false) {
        features.imageBuffer = require("../core/segment_buffers/implementations/image/index.js").default;
    ...
    if (false) {
        ...
        features.dashParsers.js = require("../parsers/manifest/dash/js-parser/index.js").default;
    }
    if (false) {
    ...
    if (HAS_NATIVE_MODE) {
        features.nativeTextTracksBuffer =
            require("../core/segment_buffers/implementations/text/native/index.js").default;
        if (false) {
    ...
    if (HAS_HTML_MODE) {
        features.htmlTextTracksBuffer =
            require("../core/segment_buffers/implementations/text/html/index.js").default;
        if (false) {
