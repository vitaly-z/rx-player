    ...
    function loop(node, style, spans, shouldTrimWhiteSpaceFromParent) {
        ...
        for (var i = 0; i < childNodes.length; i++) {
            ...
            if (currentNode.nodeName === "#text") {
                ...
                elements.push.apply(elements, loop(currentNode, newStyle, __spreadArray([currentNode], spans), shouldTrimWhiteSpaceOnSpan));
            }
        }
        return elements;
    }
...
export default function createElement(paragraph, body, regions, styles, paragraphStyle, _a) {
    ...
    if (body !== null) {
        // applies to body, div, p, region, span
        var bodyBackgroundColor = getStylingAttributes(["backgroundColor"], __spreadArray(__spreadArray([], divs), [body]), styles, regions).bodyBackgroundColor;
