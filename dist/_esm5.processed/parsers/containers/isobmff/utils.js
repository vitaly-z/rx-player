...
import { getEMSG, getMDIA, getTRAF, } from "./read";
/**
...
function parseEmsgBoxes(buffer) {
    ...
    while (offset < buffer.length) {
        ...
        if (version !== 0) {
            ...
            var emsgData = { schemeIdUri: schemeIdUri,
                value: value,
                timescale: timescale,
...
export { getMDHDTimescale, getPlayReadyKIDFromPrivateData, getTrackFragmentDecodeTime, getDurationFromTrun, getSegmentsFromSidx, patchPssh, updateBoxLength, parseEmsgBoxes, };
