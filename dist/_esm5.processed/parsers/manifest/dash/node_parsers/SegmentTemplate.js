...
export default function parseSegmentTemplate(root) {
    var _a, _b, _c;
    var _d = parseSegmentBase(root), base = _d[0], segmentBaseWarnings = _d[1];
    ...
    ret = objectAssign({}, base, { duration: base.duration, timelineParser: timelineParser });
    ...
    ret.presentationTimeOffset = ((_a = ret.presentationTimeOffset) !== null && _a !== void 0 ? _a : 0) +
        (((_b = ret.timescale) !== null && _b !== void 0 ? _b : 1) *
            ((_c = window.contentOffset) !== null && _c !== void 0 ? _c : 0));
