 ...
 * @returns {Function}
 */
export declare function generateXLinkChildrenParser(xlinkObj: {
    periods: IPeriodIntermediateRepresentation[];
}, linearMemory: WebAssembly.Memory, parsersStack: ParsersStack, fullMpd: ArrayBuffer): IChildrenParser;
