...
function parseCompleteIntermediateRepresentation(mpdIR, args, xlinkInfos) {
    ...
    var baseURL = resolveURL(normalizeBaseURL(args.url == null ? "" :
        args.url), rootChildren.baseURL !== undefined ?
    ...
    var availabilityTimeOffset = (_b = (_a = rootChildren.baseURL) === null || _a === void 0 ? void 0 : _a.attributes.availabilityTimeOffset, (_b !== null && _b !== void 0 ? _b : 0));
    ...
    var _e = getMinimumAndMaximumPosition(parsedMPD), minTime = _e[0], maxTime = _e[1];
    ...
    if (!isDynamic) {
        ...
        else if (((_c = parsedPeriods[0]) === null || _c === void 0 ? void 0 : _c.start) !== undefined) {
            parsedMPD.minimumTime = { isContinuous: false,
        ...
        if (maxTime !== undefined) {
            ...
            var end = (_d = lastPeriod.end, (_d !== null && _d !== void 0 ? _d : (lastPeriod.duration !== undefined ?
