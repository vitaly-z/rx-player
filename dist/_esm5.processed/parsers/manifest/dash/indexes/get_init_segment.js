...
export default function getInitSegment(index) {
    ...
    return { id: "init",
        ...
        range: initialization != null ? initialization.range :
            undefined,
        indexRange: index.indexRange, mediaURLs: (_a = initialization === null || initialization === void 0 ? void 0 : initialization.mediaURLs) !== null && _a !== void 0 ? _a : null, timescale: index.timescale,
