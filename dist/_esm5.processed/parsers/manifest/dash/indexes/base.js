...
var BaseRepresentationIndex = /** @class */ (function () {
    ...
    function BaseRepresentationIndex(index, context) {
        var periodStart = context.periodStart, periodEnd = context.periodEnd, representationBaseURLs = context.representationBaseURLs, representationId = context.representationId, representationBitrate = context.representationBitrate;
        var timescale = index.timescale;
        ...
        this._index = { indexRange: index.indexRange,
            ...
            initialization: { mediaURLs: mediaURLs, range: range },
