...
var ListRepresentationIndex = /** @class */ (function () {
    ...
    function ListRepresentationIndex(index, context) {
        ...
        this._index = { list: list, timescale: index.timescale,
            duration: index.duration, indexTimeOffset: indexTimeOffset, indexRange: index.indexRange,
    ...
    ListRepresentationIndex.prototype.getSegments = function (fromTime, dur) {
        ...
        while (i <= length) {
            ...
            var args = { id: String(i),
                ...
                isInit: false, range: range,
                duration: duration,
                timescale: timescale,
                mediaURLs: mediaURLs, timestampOffset: -(index.indexTimeOffset / timescale) };
            segments.push(args);
            i++;
        }
        return segments;
