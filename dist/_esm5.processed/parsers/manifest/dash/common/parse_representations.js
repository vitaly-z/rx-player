...
export default function parseRepresentations(representationsIR, adaptation, adaptationInfos) {
    ...
    var _loop_1 = function (representation) {
        ...
        var representationInfos = objectAssign({}, adaptationInfos, { availabilityTimeOffset: availabilityTimeOffset, availabilityTimeComplete: availabilityTimeComplete, unsafelyBaseOnPreviousRepresentation: unsafelyBaseOnPreviousRepresentation, adaptation: adaptation, inbandEventStreams: inbandEventStreams });
