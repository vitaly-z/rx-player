...
export default function parsePeriods(periodsIR, contextInfos) {
    ...
    var _loop_1 = function (i) {
        ...
        var periodInfos = { aggressiveMode: contextInfos.aggressiveMode, availabilityTimeComplete: availabilityTimeComplete, availabilityTimeOffset: availabilityTimeOffset, baseURLs: periodBaseURLs, manifestBoundsCalculator: manifestBoundsCalculator, end: periodEnd, isDynamic: isDynamic, manifestProfiles: contextInfos.manifestProfiles, receivedTime: receivedTime, segmentTemplate: periodIR.children.segmentTemplate,
        ...
        var namespaces = ((_e = contextInfos.xmlNamespaces) !== null && _e !== void 0 ? _e : [])
