...
var ManifestBoundsCalculator = /** @class */ (function () {
     ...
     */
    ManifestBoundsCalculator.prototype.estimateMinimumBound = function () {
     ...
     * @return {number|undefined}
     */
    ManifestBoundsCalculator.prototype.estimateMaximumBound = function () {
        if (this._isDynamic &&
...
export default ManifestBoundsCalculator;
