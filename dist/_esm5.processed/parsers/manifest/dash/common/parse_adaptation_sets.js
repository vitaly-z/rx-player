                ...
                var _loop_1 = function (id) {
                    ...
                    if (switchingInfos != null &&
                        ...
                        if (adaptationToMergeInto != null &&
                            ...
                            (_k = adaptationToMergeInto.representations)
                                .push.apply(_k, parsedAdaptationSet.representations);
                            mergedInto = adaptationToMergeInto;
                        }
                    }
                };
                // look if we have to merge this into another Adaptation
                for (var _j = 0, adaptationSetSwitchingIDs_1 = adaptationSetSwitchingIDs; _j < adaptationSetSwitchingIDs_1.length; _j++) {
                    var id = adaptationSetSwitchingIDs_1[_j];
                    _loop_1(id);
                }
                if (isMainAdaptation) {
