...
export default function parseLocalManifest(localManifest) {
    ...
    return { availabilityStartTime: 0,
        ...
        isLive: false,
        uris: [], timeBounds: { absoluteMinimumTime: (_a = getMinimumPosition(parsedPeriods)) !== null && _a !== void 0 ? _a : 0, timeshiftDepth: null, maximumTimeData: { isLinear: false, value: (_b = getMaximumPosition(parsedPeriods)) !== null && _b !== void 0 ? _b : 0, time: performance.now() }, }, periods: parsedPeriods };
}
/**
 * @param {Object} period
 * @returns {Object}
