...
export default function assert(assertion, message) {
    if (1 /* __ENVIRONMENT__.DEV */ === 0 /* __ENVIRONMENT__.CURRENT_ENV */ && !assertion) {
 ...
 */
export function assertInterface(o, iface, name) {
    if (name === void 0) { name = "object"; }
    assert(!isNullOrUndefined(o), "".concat(name, " should be an object"));
    for (var k in iface) {
