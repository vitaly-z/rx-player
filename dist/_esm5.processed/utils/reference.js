 ...
 * @returns {Observable}
 */
export default function createSharedReference(initialValue) {
    ...
    return {
        ...
        waitUntilDefined: function (cb, options) {
            if (value !== undefined) {
                cb(value);
                return;
            }
            ...
            var childCanceller = new TaskCanceller();
            if ((options === null || options === void 0 ? void 0 : options.clearSignal) !== undefined) {
                options.clearSignal.register(function () { return childCanceller.cancel(); });
            }
