...
export default function fetchRequest(options) {
    ...
    return fetch(options.url, { headers: headers, method: "GET",
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!data.done && !isNullOrUndefined(data.value)) {
                                ...
                                return [2 /*return*/, { duration: duration, receivedTime: receivedTime, sendingTime: sendingTime, size: size, status: response.status,
                                        url: response.url }];
                            }
                            return [2 /*return*/, readBufferAndSendEvents()];
                    }
