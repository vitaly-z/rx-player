 ...
 */
export default function throttle<T, U, V>(func: (arg1: T) => Observable<V>): (arg1: T) => Observable<V>;
export default function throttle<T, U, V>(func: (arg1: T, arg2: U) => Observable<V>): (arg1: T, arg2: U) => Observable<V>;
export default function throttle<T, U, V, W>(func: (arg1: T, arg2: U, arg3: V) => Observable<W>): (arg1: T, arg2: U, arg3: V) => Observable<W>;
