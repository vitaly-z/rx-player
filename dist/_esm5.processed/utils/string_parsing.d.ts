 ...
 * @returns {Uint8Array}
 */
declare function strToLeUtf16(str: string): Uint8Array;
/**
 * Construct string from the little-endian UTF-16 code units given.
 * @param {Uint8Array} bytes
 * @returns {string}
 */
declare function leUtf16ToStr(bytes: Uint8Array): string;
/**
...
export { bytesToHex, hexToBytes, strToUtf8, utf8ToStr, strToLeUtf16, leUtf16ToStr, guidToUuid, };
