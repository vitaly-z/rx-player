...
import { IAdaptation, IExposedAdaptation, IExposedManifest, IExposedPeriod, IExposedRepresentation, IExposedSegment, IManifest, IPeriod, IRepresentation, IRepresentationFilter, ISegment, ISupplementaryImageTrack, ISupplementaryTextTrack } from "../manifest";
...
export declare type ILoadedManifestFormat = Document | string | ArrayBuffer | IMetaPlaylist | ILocalManifest | IManifest;
