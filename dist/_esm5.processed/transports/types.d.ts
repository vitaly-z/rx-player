...
export interface ITransportPipelines {
    ...
    audio: ISegmentPipeline<Uint8Array | ArrayBuffer | null, Uint8Array | ArrayBuffer | null>;
    /** Functions allowing to load an parse video segments. */
    video: ISegmentPipeline<Uint8Array | ArrayBuffer | null, Uint8Array | ArrayBuffer | null>;
    /** Functions allowing to load an parse text (e.g. subtitles) segments. */
    text: ISegmentPipeline<Uint8Array | ArrayBuffer | string | null, ITextTrackSegmentData | null>;
    /** Functions allowing to load an parse image (e.g. thumbnails) segments. */
    image: ISegmentPipeline<Uint8Array | ArrayBuffer | null, IImageTrackSegmentData | null>;
}
...
export interface ISegmentPipeline<TLoadedFormat, TParsedSegmentDataFormat> {
    ...
    parser: ISegmentParser<TLoadedFormat, TParsedSegmentDataFormat>;
}
/**
 ...
 * @returns {Observable.<Object>}
 */
export declare type ISegmentLoader<TLoadedFormat> = (x: ISegmentLoaderArguments) => Observable<ISegmentLoaderEvent<TLoadedFormat>>;
/**
 * Segment parser function, allowing to parse a segment of any type.
 * @param {Object} x
 * @returns {Observable.<Object>}
 */
export declare type ISegmentParser<TLoadedFormat, TParsedSegmentDataFormat> = (x: ISegmentParserArguments<TLoadedFormat>) => 
/**
 * The parsed data.
 *
 * Can be of two types:
 ...
 */
ISegmentParserParsedInitSegment<TParsedSegmentDataFormat> | ISegmentParserParsedSegment<TParsedSegmentDataFormat>;
