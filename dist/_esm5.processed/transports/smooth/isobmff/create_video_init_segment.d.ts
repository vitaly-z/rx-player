 ...
 * @returns {Uint8Array}
 */
export default function createVideoInitSegment(timescale: number, width: number, height: number, hRes: number, vRes: number, nalLength: number, codecPrivateData: string, keyId?: Uint8Array): Uint8Array;
