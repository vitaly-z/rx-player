...
import { CustomSegmentLoader, ISegmentContext, ISegmentLoaderCallbacks, ISegmentLoaderResultSegmentCreated, ISegmentLoaderResultSegmentLoaded } from "../types";
/**
...
declare const generateSegmentLoader: ({ checkMediaSegmentIntegrity, customSegmentLoader, }: {
    ...
    customSegmentLoader?: CustomSegmentLoader | undefined;
