 ...
 * @returns {Boolean}
 */
declare function isMP4EmbeddedTrack(representation: IRepresentation): boolean;
export { extractISML, extractToken, isMP4EmbeddedTrack, replaceToken, resolveManifest, };
