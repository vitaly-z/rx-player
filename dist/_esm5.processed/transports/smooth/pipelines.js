    ...
    var segmentPipeline = {
        ...
        parser: function (_a) {
            ...
            if (segment.isInit) {
                ...
                var segmentProtections = representation.getProtectionsInitializationData();
                return observableOf({ type: "parsed-init-segment", value: { initializationData: data, segmentProtections: segmentProtections, 
    ...
    var textTrackPipeline = {
        ...
        parser: function (_a) {
            ...
            return observableOf({ type: "parsed-segment", value: { chunkData: { type: _sdType,
                        data: _sdData, language: language, timescale: _sdTimescale,
                        start: _sdStart,
                        end: _sdEnd },
