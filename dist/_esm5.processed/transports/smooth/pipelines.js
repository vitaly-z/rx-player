...
export default function (options) {
    ...
    var manifestPipeline = {
        ...
        parseManifest: function (manifestData, parserOptions, onWarnings) {
            var _a;
            return __awaiter(this, void 0, void 0, function () {
                var url, manifestReceivedTime, responseData, documentData, parserResult, _b, manifest, warnings;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            url = (_a = manifestData.url) !== null && _a !== void 0 ? _a : parserOptions.originalUrl;
                            manifestReceivedTime = manifestData.receivedTime, responseData = manifestData.responseData;
                            documentData = typeof responseData === "string" ?
                                new DOMParser().parseFromString(responseData, "text/xml") :
                                responseData;
                            parserResult = smoothManifestParser(documentData, url, manifestReceivedTime);
                            return [4 /*yield*/, createManifestObject(parserResult, {
                                    representationFilter: options.representationFilter,
                                    supplementaryImageTracks: options.supplementaryImageTracks,
                                    supplementaryTextTracks: options.supplementaryTextTracks,
                                })];
                        case 1:
                            _b = _c.sent(), manifest = _b[0], warnings = _b[1];
