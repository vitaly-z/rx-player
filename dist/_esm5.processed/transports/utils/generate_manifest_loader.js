...
function generateRegularManifestLoader(preferredType) {
    return function regularManifestLoader(_a) {
        var url = _a.url;
        if (url === undefined) {
            throw new Error("Cannot perform HTTP(s) request. URL not known");
        }
        return request({ url: url, responseType: preferredType });
    };
}
/**
 ...
 * @returns {Function}
 */
export default function generateManifestLoader(_a, preferredType) {
