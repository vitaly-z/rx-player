...
import { IChunkTimingInfos, ITextTrackSegmentData } from "../types";
/**
...
}, chunkBytes: Uint8Array, chunkInfos: IChunkTimingInfos | null, isChunked: boolean): ITextTrackSegmentData | null;
/**
 * @param {Object} content
 * @param {ArrayBuffer|UInt8Array|null} chunkData
 * @param {Object|null} chunkInfos
