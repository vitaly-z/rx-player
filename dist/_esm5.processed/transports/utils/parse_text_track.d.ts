 ...
 * @returns {string}
 */
export declare function getISOBMFFTextTrackFormat(representation: IRepresentation): "ttml" | "vtt";
/**
 * Returns the a string expliciting the format of a text track in plain text.
 * @param {Object} representation
 * @returns {string}
 */
export declare function getPlainTextTrackFormat(representation: IRepresentation): "ttml" | "sami" | "vtt" | "srt";
/**
