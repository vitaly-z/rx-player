 ...
 */
import { IAdaptationType, Representation } from "../../manifest";
/**
 ...
 */
export default function inferSegmentContainer(adaptationType: IAdaptationType, representation: Representation): "webm" | "mp4" | undefined;
