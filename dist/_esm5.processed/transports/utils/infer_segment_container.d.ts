 ...
 */
import { IAdaptationType, IRepresentation } from "../../manifest";
/**
 ...
 */
export default function inferSegmentContainer(adaptationType: IAdaptationType, representation: IRepresentation): "webm" | "mp4" | undefined;
