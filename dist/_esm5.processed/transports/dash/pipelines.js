...
import { imageLoader, imageParser, } from "./image_pipelines";
...
export default function (options) {
    var manifestLoader = generateManifestLoader({ customManifestLoader: options.manifestLoader }, mightUseDashWasmFeature() ? "text" :
        "arraybuffer");
