...
export default function generateAudioVideoSegmentParser(_a) {
    ...
    return function audioVideoSegmentParser(_a) {
        ...
        var period = content.period, representation = content.representation, segment = content.segment, manifest = content.manifest;
        ...
        return observableOf({ type: "parsed-init-segment", value: { initializationData: chunkData, protectionDataUpdate: protectionDataUpdate, initTimescale: parsedTimescale } });
    };
}
