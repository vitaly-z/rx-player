...
describe("utils - array-includes", () => {
  ...
  it("should be true if a string is included", () => {
    ...
    expect(arrayIncludes(["abc", "foo", "toto", "bar", "baz"], "abc")).toBe(
      true
    );
    expect(arrayIncludes(["abc", "foo", "toto", "bar", "baz"], "foo")).toBe(
      true
    );
    expect(arrayIncludes(["abc", "foo", "toto", "bar", "baz"], "toto")).toBe(
      true
    );
    expect(arrayIncludes(["abc", "foo", "toto", "bar", "baz"], "bar")).toBe(
      true
    );
    expect(arrayIncludes(["abc", "foo", "toto", "bar", "baz"], "baz")).toBe(
      true
    );
