...
const arrayb1 = new Uint8Array([
  5, 5, 6, 87, 87, 76, 64, 35, 35, 68, 41, 14, 87, 1, 35, 87, 255, 87, 12, 87,
  8,
]);
const arrayb2 = new Uint8Array([
  7, 5, 6, 87, 87, 76, 64, 35, 35, 68, 41, 14, 87, 1, 35, 87, 255, 87, 12, 87,
  8,
]);
const arrayb3 = new Uint8Array([
  8, 5, 6, 87, 87, 76, 64, 35, 35, 68, 41, 14, 87, 1, 35, 87, 255, 87, 12, 87,
  8,
]);
