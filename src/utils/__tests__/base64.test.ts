...
describe("base64ToBytes", () => {
  ...
  it("should convert a base64 to an Uint8Array", () => {
    ...
    expect(base64ToBytes("JGV4cGVjdChiYXNlNjRUb1VpbnQ4QXJyYXkoIiIp")).toEqual(
      new Uint8Array([
        36, 101, 120, 112, 101, 99, 116, 40, 98, 97, 115, 101, 54, 52, 84, 111,
        85, 105, 110, 116, 56, 65, 114, 114, 97, 121, 40, 34, 34, 41,
      ])
    );
    expect(base64ToBytes(window.btoa("toto"))).toEqual(
...
describe("bytesToBase64", () => {
  ...
  it("should convert a base64 to an Uint8Array", () => {
    const bytesToBase64 = jest.requireActual("../base64").bytesToBase64;
    expect(
      bytesToBase64(new Uint8Array([194, 128, 194, 129, 239, 191, 190]))
    ).toEqual("woDCge+/vg==");
    expect(
    ...
    expect(
      bytesToBase64(
        new Uint8Array([
          36, 101, 120, 112, 101, 99, 116, 40, 98, 97, 115, 101, 54, 52, 84,
          111, 85, 105, 110, 116, 56, 65, 114, 114, 97, 121, 40, 34, 34, 41,
        ])
      )
