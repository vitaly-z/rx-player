...
describe("dash parser helpers", function () {
  ...
  describe("parseDateTime", () => {
    it("should correctly parse a given date into a timestamp", () => {
      ...
      expect(parseDateTime("1998-11-22T10:40:50Z", "b")).toEqual([
        911731250,
        null,
      ]);
      expect(parseDateTime("1960-01-01T00:00:00Z", "c")).toEqual([
        -315619200,
        null,
      ]);
    });
  ...
  describe("parseDuration", () => {
    it("should correctly parse duration in ISO8061 format", function () {
      expect(parseDuration("P18Y9M4DT11H9M8S", "fooba")).toEqual([
        591361748,
        null,
      ]);
    });
    ...
    it("should correctly parse duration if missing the month", function () {
      expect(parseDuration("P18Y4DT11H9M8S", "fooba")).toEqual([
        568033748,
        null,
      ]);
    });
    ...
    it("should correctly parse duration if missing the day", function () {
      expect(parseDuration("P18Y9MT11H9M8S", "fooba")).toEqual([
        591016148,
        null,
      ]);
    });
    ...
    it("should correctly parse duration if missing the hours", function () {
      expect(parseDuration("P18Y9M4DT9M8S", "fooba")).toEqual([
        591322148,
        null,
      ]);
    });
    ...
    it("should correctly parse duration if missing the minutes", function () {
      expect(parseDuration("P18Y9M4DT11H8S", "fooba")).toEqual([
        591361208,
        null,
      ]);
    });
    ...
    it("should correctly parse duration if missing the seconds", function () {
      expect(parseDuration("P18Y9M4DT11H9M", "fooba")).toEqual([
        591361740,
        null,
      ]);
    });
