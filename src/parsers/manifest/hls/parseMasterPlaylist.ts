...
export default function parseMasterPlaylist(
  ...
  const everyRessources = masterPlaylistIR.variants
                            ...
                            .concat(masterPlaylistIR.medias
                                      .map(v => v.uri)
                                      .filter((uri) => uri !== undefined))
  ...
  function continueParsing(
    ...
    const mainAdaptation : IParsedAdaptation = { id: "default-video-track",
    ...
    const manifest : IParsedManifest = { isDynamic: false,
                                         isLive: false,
                                         periods: [period],
                                         transportType: "hls",
  ...
  return { type: "needs-ressources",
           value: { ressources: everyRessources,
                    continue : continueParsing } };
}
