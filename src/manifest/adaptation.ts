...
export default class Adaptation {
  ...
  constructor(
    ...
    options : { baseRepresentations? : Representation[];
    ...
    const representations = options.baseRepresentations ?? [];
    let isSupported : boolean = representations.some(r => r.isSupported);
