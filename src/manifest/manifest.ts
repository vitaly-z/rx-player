...
import { type IInitializationDataInfo } from "../core/eme";
import {
  type ICustomError,
  MediaError,
} from "../errors";
...
import {
  ...
  type IDecipherabilityUpdateElement,
  type IManifest,
  type IManifestEvents,
  type IRepresentation,
  type ISupplementaryImageTrack,
  type ISupplementaryTextTrack,
