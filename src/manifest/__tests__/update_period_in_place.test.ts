...
describe("Manifest - updatePeriodInPlace", () => {
  let mockOldVideoRepresentation1Replace:
    | jest.MockInstance<void, []>
    | undefined;
  let mockOldVideoRepresentation2Replace:
    | jest.MockInstance<void, []>
    | undefined;
  let mockOldVideoRepresentation3Replace:
    | jest.MockInstance<void, []>
    | undefined;
  let mockOldVideoRepresentation4Replace:
    | jest.MockInstance<void, []>
    | undefined;
  let mockOldAudioRepresentationReplace:
    | jest.MockInstance<void, []>
    | undefined;
  let mockOldVideoRepresentation1Update:
    | jest.MockInstance<void, []>
    | undefined;
  let mockOldVideoRepresentation2Update:
    | jest.MockInstance<void, []>
    | undefined;
  let mockOldVideoRepresentation3Update:
    | jest.MockInstance<void, []>
    | undefined;
  let mockOldVideoRepresentation4Update:
    | jest.MockInstance<void, []>
    | undefined;
  let mockOldAudioRepresentationUpdate: jest.MockInstance<void, []> | undefined;
  let mockNewVideoRepresentation1Replace:
    | jest.MockInstance<void, []>
    | undefined;
  let mockNewVideoRepresentation2Replace:
    | jest.MockInstance<void, []>
    | undefined;
  let mockNewVideoRepresentation3Replace:
    | jest.MockInstance<void, []>
    | undefined;
  let mockNewVideoRepresentation4Replace:
    | jest.MockInstance<void, []>
    | undefined;
  let mockNewAudioRepresentationReplace:
    | jest.MockInstance<void, []>
    | undefined;
  let mockNewVideoRepresentation1Update:
    | jest.MockInstance<void, []>
    | undefined;
  let mockNewVideoRepresentation2Update:
    | jest.MockInstance<void, []>
    | undefined;
  let mockNewVideoRepresentation3Update:
    | jest.MockInstance<void, []>
    | undefined;
  let mockNewVideoRepresentation4Update:
    | jest.MockInstance<void, []>
    | undefined;
