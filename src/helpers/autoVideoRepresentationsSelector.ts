...
export function createAutoVideoRepresentationSelector(
  ...
  // resilience reasons.
  rxPlayer.addEventListener("lostVideoTrack", onVideoTrackLost);
  ...
  return {
    ...
    dispose() : void {
      ...
      rxPlayer.removeEventListener("lostVideoTrack", onVideoTrackLost);
    },
  };
  ...
  function onVideoTrackLost(e : ILostVideoTrackEventPayload) {
    runSelectorForPeriod(e.period);
  }
