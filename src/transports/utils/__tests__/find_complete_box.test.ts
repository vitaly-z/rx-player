...
describe("transports utils - findCompleteBox", () => {
  it("should return -1 if the box is not found", () => {
    const byteArr = new Uint8Array([
      0, 0, 0, 9, 0x64, 0x67, 0x32, 0x55, 4, 0, 0, 0, 10, 0x88, 0x68, 0x47,
      0x53, 12, 88,
    ]);
  ...
  it("should return a box if a later one is incomplete", () => {
    const byteArr = new Uint8Array([
      0, 0, 0, 9, 0x64, 0x67, 0x32, 0x55, 4, 0, 0, 0, 12, 0x58, 0x58, 0x57,
      0x53, 15, 99, 87, 77, 0, 0, 0, 10, 0x88, 0x68, 0x47, 0x53, 12,
    ]);
